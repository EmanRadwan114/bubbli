...
const Contact = () => {
  const contactInfo = [
    ...
    {
      icon: (
        <MapPin className="text-primary dark:text-primary-dark" size={36} />
      ),
      title: "Address",
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          ...
          <section className="text-center mb-16">
            ...
            <p className="text-xl text-gray-700 dark:text-gray-300 max-w-3xl mx-auto">
              Have questions about our gifts? Need help with an order? Or maybe
              you just want to share your gift ideas with us?
            </p>
          </section>
          ...
          <section className="bg-primary dark:bg-primary-dark text-white rounded-xl p-10 text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              {[
                ...
                <div
                  key={index}
                  className="bg-white/20 p-5 rounded-lg backdrop-blur-sm"
                >
