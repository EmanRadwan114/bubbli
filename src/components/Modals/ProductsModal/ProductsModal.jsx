  ...
  return (
    ...
    >
      ...
      >
        <button
          onClick={closeModal}
          className="absolute top-3 right-3 text-gray-600 dark:text-white  hover:text-gray-800 dark:hover:text-gray-100 hover:bg-[rgba(0,0,0,0.15)] dark:hover:bg-[rgba(255,255,255,0.15)] p-1 px-2 rounded-lg cursor-pointer"
        >
          <X size={20} />
        </button>

        {activeModal !== "view" && (
          <h2 className="text-2xl font-bold text-accent  dark:text-accent-dark mb-2 border-b pb-2 border-gray-200 dark:border-gray-700">
        ...
        <form onSubmit={formik.handleSubmit} className="space-y-4">
          <div className="grid grid-cols-1 gap-4">
            <div>
              <label className="block mb-1 font-medium text-accent  dark:text-light">
                Title
              </label>
              <input
                name="title"
                ...
                {["bestseller", "limited", "new", "hot", "deal"].map(
                  (label) => (
                    ...
                    >
                      ...
                      />
                      <span className="text-accent  dark:text-light cursor-pointer">
                        {label}
                      </span>
                    </label>
                  )
          ...
          <div className="pt-4">
            <button
              ...
              className="w-full py-3 rounded-lg btn-modal-accent text-white font-medium"
            >
              {activeModal === "add" ? "Add Product" : "Update Product"}
            </button>
          </div>
